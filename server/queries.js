...
export async function createContent(newContent) {
  try {
    const insertedContent = await db.query.content.insert({
      data: {
...
export async function getAllIdeas() {
  try {
    const ideaContents = await db.query.content.findMany({
...
export async function getMyIdeas(userId) {
  try {
...
export async function getMyExperiences(userId) {
  try {
    const userContentIds = await db.query.contentHistory.findMany({
      where: (model, { eq }) => eq(model.userId, userId),
    });
...
export async function deleteMyIdea(userId, ideaId) {
  try {
...
export async function deleteMyExperience(userId, experienceId) {
  try {
...
export async function updateMyIdea(userId, ideaId, updatedContent) {
  try {
    const userIdea = await db.query.contents.findFirst({
      where: {
        id: ideaId,
...
export async function updateMyExperience(userId, experienceId, updatedContent) {
  try {
    const userExperience = await db.query.contents.findFirst({
      where: {
        id: experienceId,
